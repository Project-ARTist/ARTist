 ...
 *
 */
#include "optimizing/artist/api/filtering/filter.h"
#include "codelib.h"
#include "artist.h"
#include "optimizing/artist/api/io/filesystem_helper.h"

#ifndef ART_API_MODULES_MODULE_H_
#define ART_API_MODULES_MODULE_H_
...
class Module {
 public:
   ...
   * @return ARTist pass
   */
  virtual HArtist* createPass(const ArtistMethodInfo& method_info) const = 0;
...
#endif  // ART_API_MODULES_MODULE_H_
